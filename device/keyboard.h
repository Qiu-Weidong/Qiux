...
#define FLAG_EXT 0x8000     /* Normal function keys		*/
#define FLAG_SHIFT_L 0x0100 /* Shift key			*/
#define FLAG_SHIFT_R 0x0200 /* Shift key			*/
#define FLAG_CTRL_L 0x1000  /* Control key			*/
#define FLAG_CTRL_R 0x2000   /* Control key			*/
#define FLAG_ALT_L 0x400   /* Alternate key		*/
#define FLAG_ALT_R 0x800   /* Alternate key		*/
#define FLAG_MAKE 0x4000   /* Make code or Break code */
#define MASK      0x80ff
...
#define WIN (0x05 + FLAG_EXT) /* L GUI	*/
...
// #define REBOOT (0x2C + FLAG_EXT) /* Reboot   */

// /* Num Pad */
#define PAD_SLASH (0x2D + FLAG_EXT) /* /		*/
#define PAD_STAR (0x2E + FLAG_EXT)  /* *		*/
#define PAD_MINUS (0x2F + FLAG_EXT) /* -		*/
#define PAD_PLUS (0x30 + FLAG_EXT)  /* +		*/
#define PAD_ENTER (0x31 + FLAG_EXT) /* Enter	*/
#define PAD_DOT (0x32 + FLAG_EXT)   /* .		*/
#define PAD_0 (0x33 + FLAG_EXT)     /* 0		*/
#define PAD_1 (0x34 + FLAG_EXT)     /* 1		*/
#define PAD_2 (0x35 + FLAG_EXT)     /* 2		*/
#define PAD_3 (0x36 + FLAG_EXT)     /* 3		*/
#define PAD_4 (0x37 + FLAG_EXT)     /* 4		*/
#define PAD_5 (0x38 + FLAG_EXT)     /* 5		*/
#define PAD_6 (0x39 + FLAG_EXT)     /* 6		*/
#define PAD_7 (0x3A + FLAG_EXT)     /* 7		*/
#define PAD_8 (0x3B + FLAG_EXT)     /* 8		*/
#define PAD_9 (0x3C + FLAG_EXT)     /* 9		*/
